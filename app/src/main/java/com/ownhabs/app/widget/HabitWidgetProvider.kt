package com.ownhabs.app.widget
...
class HabitWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE_HABIT = "com.ownhabs.app.widget.ACTION_TOGGLE_HABIT"
    ...
    private suspend fun isDoneToday(app: OwnHabsApp, habit: HabitEntity): Boolean {
